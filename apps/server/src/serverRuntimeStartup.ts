...
import * as AgentRelayThreadDiscoveryReactor from "./provider/Services/AgentRelayThreadDiscoveryReactor.ts";
...
export const make = (options?: StartupOptions) =>
  Effect.gen(function* () {
    ...
    const agentRelayThreadDiscoveryReactor =
      yield* AgentRelayThreadDiscoveryReactor.AgentRelayThreadDiscoveryReactor;
    ...
    const startup = Effect.gen(function* () {
      ...
      yield* runStartupPhase(
        ...
        Effect.gen(function* () {
          ...
          yield* agentRelayThreadDiscoveryReactor.start().pipe(Scope.provide(reactorScope));
        }),
      );
